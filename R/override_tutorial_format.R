...
# This is only used when setting the template to tutorialExtras.
...
tutorial_html_dependency <- function() {
  htmltools::htmlDependency(
    name = "tutorial",
    version = utils::packageVersion("tutorialExtras"),
...
#'
#' Copied from learnr so that I can customize tutorial
#'
#'
...
tutorial <- function(
  ...
  extra_dependencies <- append(extra_dependencies, list(
    tutorialExtras:::tutorial_html_dependency(),
    learnr:::tutorial_i18n_html_dependency(language),
    htmltools::htmlDependency(
      name = "tutorial-format",
      version = utils::packageVersion("tutorialExtras"),
      src = system.file("rmarkdown/templates/tutorial/resources", package = "tutorialExtras"),
